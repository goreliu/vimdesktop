...
Internal:
	...
	__v.SetAction("<1>","Number 1")
	__v.SetAction("<2>","Number 2")
	__v.SetAction("<3>","Number 3")
	__v.SetAction("<4>","Number 4")
	__v.SetAction("<5>","Number 5")
	__v.SetAction("<6>","Number 6")
	__v.SetAction("<7>","Number 7")
	__v.SetAction("<8>","Number 8")
	__v.SetAction("<9>","Number 9")
	__v.SetAction("<0>","Number 0")
	__v.SetAction("<>","Null")
