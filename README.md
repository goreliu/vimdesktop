...
2020 年起，我不再发布新版本，不再保证原有功能继续保留，不再保证配置的向后兼容性，不再回答任何功能相关问题，不再维护文档，我会根据自己的需求随意修改代码，请不要随意更新。因为很多陈旧代码的功能我并不需要，也无力测试，放在那里会让软件的维护变得十分困难，所以我已经几年时间没有大改了。为了让这个软件继续活下去（即使只有我一个人用），我必须放弃向后兼容的包袱，大刀阔斧地修改。如果有人想维护该软件的公共版本，可以通过 ly50247@126.com 联系我。
