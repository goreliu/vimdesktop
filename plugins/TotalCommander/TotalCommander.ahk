TotalCommander:
    ...
    vim.SetWin("TotalCommander", "TTOTAL_CMD")
    ...
    vim.mode("insert", "TotalCommander")
    vim.SetTimeOut(800, "TotalCommander")
    vim.map("<esc>", "<TC_NormalMode>", "TotalCommander")

    vim.mode("search", "TotalCommander")
    vim.map("<esc>", "<TC_NormalMode>", "TotalCommander")

    vim.mode("normal", "TotalCommander")

    ;复制/移动到右侧 f取file的意思 filecopy
    vim.map("fc", "<cm_CopyOtherpanel>", "TotalCommander")
    vim.map("fx", "<cm_MoveOnly>", "TotalCommander")

    ;使用队列复制/移动到右侧 q-queue, fcq会影响对fc的使用，改用fqc/fqx的方式
    vim.map("fqc", "<TC_CopyUseQueues>", "TotalCommander")
    vim.map("fqx", "<TC_MoveUseQueues>", "TotalCommander")

    ;ff复制到剪切板 fz剪切到剪切板 fv粘贴
    vim.map("ff", "<cm_CopyToClipboard>", "TotalCommander")
    vim.map("fz", "<cm_CutToClipboard>", "TotalCommander")
    vim.map("fv", "<cm_PasteFromClipboard>", "TotalCommander")
    ...
    vim.map("gl", "<TC_GotoNextDirOther>", "TotalCommander")
    vim.map("Vh", "<cm_SwitchIgnoreList>", "TotalCommander")
    vim.map("0", "<0>", "TotalCommander")
    vim.map("1", "<1>", "TotalCommander")
    vim.map("2", "<2>", "TotalCommander")
    vim.map("3", "<3>", "TotalCommander")
    vim.map("4", "<4>", "TotalCommander")
    vim.map("5", "<5>", "TotalCommander")
    vim.map("6", "<6>", "TotalCommander")
    vim.map("7", "<7>", "TotalCommander")
    vim.map("8", "<8>", "TotalCommander")
    vim.map("9", "<9>", "TotalCommander")
    vim.map("k", "<up>", "TotalCommander")
    vim.map("K", "<TC_UpSelect>", "TotalCommander")
    vim.map("j", "<down>", "TotalCommander")
    vim.map("J", "<TC_DownSelect>", "TotalCommander")
    vim.map("h", "<left>", "TotalCommander")
    vim.map("H", "<cm_GotoPreviousDir>", "TotalCommander")
    vim.map("l", "<right>", "TotalCommander")
    vim.map("L", "<cm_GotoNextDir>", "TotalCommander")
    vim.map("I", "<TC_CreateNewFile>", "TotalCommander")
    vim.map("i", "<TC_InsertMode>", "TotalCommander")
    vim.map("d", "<cm_DirectoryHotlist>", "TotalCommander")
    vim.map("D", "<cm_OpenDesktop>", "TotalCommander")
    vim.map("e", "<cm_ContextMenu>", "TotalCommander")
    vim.map("E", "<cm_ExeCuteDOS>", "TotalCommander")
    vim.map("n", "<TC_azHistory>", "TotalCommander")
    vim.map("m", "<TC_Mark>", "TotalCommander")
    vim.map("M", "<TC_Half>", "TotalCommander")
    vim.map("'", "<TC_ListMark>", "TotalCommander")
    vim.map("u", "<TC_GoToParentEx>", "TotalCommander")
    vim.map("U", "<cm_GoToRoot>", "TotalCommander")
    vim.map("o", "<cm_LeftOpenDrives>", "TotalCommander")
    vim.map("O", "<cm_RightOpenDrives>", "TotalCommander")
    vim.map("q", "<cm_SrcQuickView>", "TotalCommander")
    vim.map("r", "<cm_RenameOnly>", "TotalCommander")
    vim.map("R", "<cm_MultiRenameFiles>", "TotalCommander")
    vim.map("x", "<cm_Delete>", "TotalCommander")
    vim.map("X", "<TC_ForceDelete>", "TotalCommander")
    vim.map("w", "<cm_List>", "TotalCommander")
    vim.map("y", "<cm_CopyNamesToClip>", "TotalCommander")
    vim.map("Y", "<cm_CopyFullNamesToClip>", "TotalCommander")
    vim.map("P", "<cm_PackFiles>", "TotalCommander")
    vim.map("p", "<cm_UnpackFiles>", "TotalCommander")
    vim.map("t", "<cm_OpenNewTab>", "TotalCommander")
    vim.map("T", "<cm_OpenNewTabBg>", "TotalCommander")
    vim.map("/", "<cm_ShowQuickSearch>", "TotalCommander")
    vim.map("?", "<cm_SearchFor>", "TotalCommander")
    vim.map("[", "<cm_SelectCurrentName>", "TotalCommander")
    vim.map("{", "<cm_UnselectCurrentName>", "TotalCommander")
    vim.map("]", "<cm_SelectCurrentExtension>", "TotalCommander")
    vim.map("}", "<cm_UnSelectCurrentExtension>", "TotalCommander")
    vim.map("\", "<cm_ExchangeSelection>", "TotalCommander")
    vim.map("|", "<cm_ClearAll>", "TotalCommander")
    vim.map("-", "<cm_SwitchSeparateTree>", "TotalCommander")
    vim.map("=", "<cm_MatchSrc>", "TotalCommander")
    vim.map(",", "<cm_SrcThumbs>", "TotalCommander")
    vim.map(";", "<TC_ListMark>", "TotalCommander")
    vim.map(":", "<cm_FocusCmdLine>", "TotalCommander")
    vim.map("~", "<cm_SysInfo>", "TotalCommander")
    vim.map("``", "<TC_ToggleShowInfo>", "TotalCommander")
    vim.map("G", "<TC_LastLine>", "TotalCommander")
    vim.map("ga", "<cm_CloseAllTabs>", "TotalCommander")
    vim.map("gg", "<TC_GoToLine>", "TotalCommander")
    vim.map("g$", "<TC_LastLine>", "TotalCommander")

    ;与vim保持一致
    vim.map("gt", "<cm_SwitchToNextTab>", "TotalCommander")
    vim.map("gT", "<cm_SwitchToPreviousTab>", "TotalCommander")
    vim.map("gc", "<cm_CloseCurrentTab>", "TotalCommander")
    vim.map("gb", "<cm_OpenDirInNewTabOther>", "TotalCommander")
    vim.map("ge", "<cm_Exchange>", "TotalCommander")
    vim.map("gr", "<TC_ReOpenTab>", "TotalCommander")
    vim.map("gw", "<cm_ExchangeWithTabs>", "TotalCommander")
    vim.map("g1", "<cm_SrcActivateTab1>", "TotalCommander")
    vim.map("g2", "<cm_SrcActivateTab2>", "TotalCommander")
    vim.map("g3", "<cm_SrcActivateTab3>", "TotalCommander")
    vim.map("g4", "<cm_SrcActivateTab4>", "TotalCommander")
    vim.map("g5", "<cm_SrcActivateTab5>", "TotalCommander")
    vim.map("g6", "<cm_SrcActivateTab6>", "TotalCommander")
    vim.map("g7", "<cm_SrcActivateTab7>", "TotalCommander")
    vim.map("g8", "<cm_SrcActivateTab8>", "TotalCommander")
    vim.map("g9", "<cm_SrcActivateTab9>", "TotalCommander")
    vim.map("g0", "<TC_GoLastTab>", "TotalCommander")
    vim.map("sn", "<cm_SrcByName>", "TotalCommander")
    vim.map("se", "<cm_SrcByExt>", "TotalCommander")
    vim.map("ss", "<cm_SrcBySize>", "TotalCommander")
    vim.map("sd", "<cm_SrcByDateTime>", "TotalCommander")
    vim.map("sr", "<cm_SrcNegOrder>", "TotalCommander")
    vim.map("s1", "<cm_SrcSortByCol1>", "TotalCommander")
    vim.map("s2", "<cm_SrcSortByCol2>", "TotalCommander")
    vim.map("s3", "<cm_SrcSortByCol3>", "TotalCommander")
    vim.map("s4", "<cm_SrcSortByCol4>", "TotalCommander")
    vim.map("s5", "<cm_SrcSortByCol5>", "TotalCommander")
    vim.map("s6", "<cm_SrcSortByCol6>", "TotalCommander")
    vim.map("s7", "<cm_SrcSortByCol7>", "TotalCommander")
    vim.map("s8", "<cm_SrcSortByCol8>", "TotalCommander")
    vim.map("s9", "<cm_SrcSortByCol9>", "TotalCommander")
    vim.map("s0", "<cm_SrcUnsorted>", "TotalCommander")
    vim.map("v", "<cm_SrcCustomViewMenu>", "TotalCommander")
    vim.map("Vb", "<cm_VisButtonbar>", "TotalCommander")
    vim.map("Vd", "<cm_VisDriveButtons>", "TotalCommander")
    vim.map("Vo", "<cm_VisTwoDriveButtons>", "TotalCommander")
    vim.map("Vr", "<cm_VisDriveCombo>", "TotalCommander")
    vim.map("Vc", "<cm_VisDriveCombo>", "TotalCommander")
    vim.map("Vt", "<cm_VisTabHeader>", "TotalCommander")
    vim.map("Vs", "<cm_VisStatusbar>", "TotalCommander")
    vim.map("Vn", "<cm_VisCmdLine>", "TotalCommander")
    vim.map("Vf", "<cm_VisKeyButtons>", "TotalCommander")
    vim.map("Vw", "<cm_VisDirTabs>", "TotalCommander")
    vim.map("Ve", "<cm_CommandBrowser>", "TotalCommander")
    vim.map("zz", "<TC_Toggle_50_100Percent>", "TotalCommander")
    vim.map("zi", "<TC_WinMaxLeft>", "TotalCommander")
    vim.map("zo", "<TC_WinMaxRight>", "TotalCommander")
    vim.map("zt", "<TC_AlwayOnTop>", "TotalCommander")
    vim.map("zn", "<cm_Minimize>", "TotalCommander")
    vim.map("zm", "<cm_Maximize>", "TotalCommander")
    vim.map("zr", "<cm_Restore>", "TotalCommander")
    vim.map("zv", "<cm_VerticalPanels>", "TotalCommander")
    vim.map(".", "<Repeat>", "TotalCommander")

    vim.BeforeActionDo("TC_BeforeActionDo", "TotalCommander")
...
; 转到[count]行, 缺省第一行
<TC_GotoLine>:
    if ( count := vim.GetCount("TotalCommander")) > 1
        TC_GotoLine(count)
    else
        TC_GotoLine(1)
return
...
<TC_ToggleShowInfo>:
    vim.GetWin("TotalCommander").SetInfo(!vim.GetWin("TotalCommander").info)
return
